  ...
  <div class="wrap">
    <div class="page-left fn-left">
      <div class="mod-borrow">
        <div class="hd">
          <h2 class="pngbg"><i class="icon icon-ttyx"></i> <h1>${news.title}</h1></h2>
        </div>
        <div class="bd">
          <div class="des"><span class="fn-left">${news.lasttime}</span><a href="${news.sourceurl}" class="fn-right">${news.sourcename}&gt;&gt;</a></div>
